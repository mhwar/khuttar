...
export default async function AgentItineraryPage({
  params,
}: {
  ...
  if (!data || data.program.ownerAgentId !== profile.id) notFound();

  return (
    <>
      <PageHeader
        title={`جدول الرحلة: ${data.program.title}`}
        description="ابنِ البرنامج يوماً بيوم ثم شاركه مع عملائك"
        actions={
          <Button variant="outline" asChild>
            <Link href={`/agent/programs/${id}`}>
